...
se recibir\'{a} datos que sirvan de par\'{a}metros para la investigaci\'{o}n
...
tantop t\'{e}cnicos como estad\'{i}sticos para poder realizarse
...
esto se añade el tiempo requerido para poder administrar el proyecto. Cabe
destacar que por parte del Centro de Control de Tr\'{a}nsito del MOPT no se
incurrir\'{a} en costos significativos ya que la interaci\'{o}n con los
...
de los operadores del centro, para la estimaci\'{o}n de de los costos en los
...
actualizaciones de los datos en un rango de fechas determinado.
		...
		Las siguientes tablas ilustran el costo de la investigaci\'{o}n en base a los
conceptos que se consideran relevantes.
	...
	\begin{table}[!h]
			...
			\begin{tabular}{|c|p{3cm}|p{3cm}|p{2cm}|c|}
				...
				Salario de Investigador & 10000 & 8 & 9 & 2880000 \\ 
				\hline
			\end{tabular}
			\caption{Salarios}
			\label{tab:salary}
	...
	Sumando los totales de las tablas anteriores se obtiene un costo de 3 016 843.2
...
en la misma \'{a}rea, apoyando al tener un conocimiento claro de las
...
del proceso. 
	...
	\section{Factibilidad Legal}
		...
		Debido a que la implementaci\'{o}n no forma parte del alcance de la
investigaci\'{o}n, los aspectos legales no representan un inconveniente al
...
forma de mejorar la calidad del sistema de transporte en las ciudades.
	
	De igual forma por el nivel de abstraci\'{o}n al que se lleva la
investigaci\'{o}n no supone causar problemas de ning\'{u}n tipo, sin violar
leyes a nivel nacional. Cabe destacar que la informaci\'{o}n que proporcione el
Centro de Control de Tr\'{a}fico del MOPT no viola confidencialidad alguna
debido a que se trata de datos estad\'{i}sticos sobre tiempos ajustados a los
em\'{a}foros y la cantidad de veh\'{i}culos que hayan sido registros en un
periiodo determinado.
	
	Finalmente, la investigaci\'{o}n con sus resultados y productos generados
ser\'{a} liberada bajo licencia GNU GPL V3 y durante todo el proceso estar\'{a}
