...
\begin{table}[tb!hp]
			...
			\begin{tabular}{|p{4cm}|p{11.80cm}|}
				...
				Sistemas Avanzados de transporte público & En los cuales se involucran trenes o buses de forma que estos informen sus ubicaciones reales para que los pasajeros conozcan esto. \\ \hline
...
causa el cambio de la luz. En caso de no de no suceder esto, los intervalos de
