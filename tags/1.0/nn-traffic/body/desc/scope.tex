\section{Alcance y Limitaciones}
	...
	tr\'{a}fico, primero en la ciudad de San Jos\'{e} en las \textbf{avenidas:} 2,
	4 y 8,  y las \textbf{calles:} 12, 10, 8 y 6; que ser\'{a} tomada como base inicial para el
	...
	que sean proporcionadas por el \textit{Centro de Control de Tr\'{a}nsito del
	MOPT}.
	...
	tr\'{a}nsito no dispone de recursos para invertir en la realizaci\'{o}n de
	esto.
...
\begin{itemize}
  ...
  sistema actualmente utilizado por el Centro de Control de Tr\'{a}nsito del
  MOPT.
