...
\author{Mag Yari~Guevara Rivera,
        Eddy Miguel~Ramirez Jimenez% <-this % stops a space
...
\begin{IEEEkeywords}
Computer Society, ANN, Simulation, Traffic Lights, Model.
\end{IEEEkeywords}}
...
Como parte de las medidas para mitigar problemas de embotellamientos, el
	...
	Al persistir la presencia de embotellamientos, se presta m\'{a}s atenci\'{o}n a una serie situaciones presentadas.
	Por ejemplo, puede darse el escenario en el cual hay autom\'{o}viles esperando
	a que el sem\'{a}foro pase a verde, una vez ocurrido esto y al momento en que estos llegan a la
	...
	asignados a cada sem\'{a}foro o son causa de una sincronizan llevada a cabo para realizar el cambio de luces de esta forma.
		...
		Muchas de las interrogantes generadas a partir de los puntos anteriores,
