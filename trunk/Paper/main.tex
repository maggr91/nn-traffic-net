...
Los autores les gustaría agradecer muy profundamente al COSEVI, CONAVI y MOPT por su invaluable apoyo, la atenci\'on brindada y los datos mostrados, sin los cuales este paper no habr\'ia sido posible. En particular a %MAG acá van los nombres y puestos de las personas que te han ayudado...
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{images/FOTO-EDDY.JPG}}]{Eddy Ram\'irez-Jim\'enez}

Eddy naci\'o en 1984 en San Jos\'e, Costa Rica. Ingres\'o al Insituto Tecnológico de Costa Rica donde se grad\'ua en el a\~no de 2007 como Bachiller en Ingenier\'ia en Computaci\'on. En ese mismo a\~no recibe el premio Reto a la Excelencia otorgado por P\&G. En ese mismo per\'iodo tambi\'en labor\'o por un a\~no como web developer y administrador de base de datos para el Institio Nacional de Biodivirsidad INBio. En el 2012 recibe el Título de M\'aster en Ciencias de la Computaci\'on en el mismo Instituto Tecnol\'ogico de Costa Rica.
...
% MAG SOLO CAMBIE EL NOMBRE DEL ARCHIVO...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{images/FOTO-MAG.JPG}}]{Mag Guevara-Rivera}
Mag naci\'o en 1991 en Managua, Nicaragua. Ingres\'o a la Universidad Nacional de Costa Rica donde se gradu\'o, en el 2011, como Bachiller en Ingenier\'ia de Sistemas de Informac\'ion y en el 2012 inici\'o sus estudios de Licenciatura en la misma Universidad. Actualmente, labora en una empresa de desarrollo de software para casas de apuestas y adicionalmente trabaja en conjunto con el COSEVI, y el MOPT en la realizaci\'on de un proyecto de investigaci\'on para poder usarse en sistemas de tr\'ansito. 
\end{IEEEbiography}
