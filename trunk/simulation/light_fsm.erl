...
%%INPUT: CurrentStateData... data of the light for the current state
%%		 
%%OUTPUT: Desired Light Time to reduce delay
%%DESC: analyze behaivior of cars that passed by that lane and determine if the delay is reduced or if it have to be reduced
%% 		according to the desired delay for the lane.
eval_delay(StateData) ->
