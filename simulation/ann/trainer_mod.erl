...
init({restore, TrainerID}) ->
	...
	timer:apply_after(100, trainer_mod, train, [TrainerID,NN, RestoredData, NewCheckpointLog, now()]);
...
init({normal, TrainerID}) ->
	...
	timer:apply_after(100, trainer_mod, train, [TrainerID,NN, TrainingData, NewCheckpointLog, now()]).
